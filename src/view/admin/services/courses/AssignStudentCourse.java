...
public class AssignStudentCourse extends JDialog {
	...
	public AssignStudentCourse(int x, int y) {
		setTitle("Assign student in a course");
		...
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				boolean caIGo = checkOfInput(idCourse.getText(), idStudent.getText());
				if (caIGo) {
	...
	private boolean checkOfInput(String idCourseString, String idStudentString) {

		if (!CheckView.verifyIdCourseEmpty(idCourseString)) {
			idCourse.setText("");
			idStudent.setText("");
			return false;
		} else if (!CheckView.verifyIdStudentEmpty(idStudentString)) {
			idCourse.setText("");
			idStudent.setText("");
			return false;
			...
			idStudent.setText("");
			return false;
		} else if (!CheckView.verifyIdCourseExist(idCourseString)) {
			idCourse.setText("");
			idStudent.setText("");
			return false;
